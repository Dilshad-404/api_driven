...
public class SeleniumValidation {
	...
	public static void main(String[] args) {
		...
		System.out.println("Password is displayed or not? "+userNamePasswordField.isDisplayed());
		System.out.println("Password is functional or not? "+userNamePasswordField.isEnabled());
		...
		System.out.println("check box is displayed or not? "+chkbox.isDisplayed());
		System.out.println("check box is functional or not? "+chkbox.isEnabled());
