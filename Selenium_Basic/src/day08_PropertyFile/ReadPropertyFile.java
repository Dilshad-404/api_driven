...
public class ReadPropertyFile {
	...
	public static void main(String[] args) throws IOException{
		//Absolute path --> C:\Users\DILSHAD\Desktop\software testing\eclipse program\Selenium_Basic\propertyfiles\SignupDetails.properties
		String filePath = System.getProperty("user.dir") + "\\propertyfiles\\SignupDetails.properties";
		System.out.println("Current Dir: " + filePath);
		// file location and filename
		// Absolute path
		FileInputStream fis = new FileInputStream(
				"C:\\Users\\DILSHAD\\Desktop\\software testing\\eclipse program\\Selenium_Basic\\propertyfiles\\SignupDetails.properties");
		// or
		FileInputStream fis1 = new FileInputStream(filePath);
		// or relative path
		FileInputStream fis2 = new FileInputStream(".\\propertyfiles\\SignupDetails.properties");
